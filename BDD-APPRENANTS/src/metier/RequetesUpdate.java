...
public class RequetesUpdate {
	...
	/**
	 * Modifie le nom d'un apprenant identifié par 'id' et le remplace avec la valeur de 'nouveauNom'  
	 * @param id
	 * @param nouveauNom
	...
	public static void ajouterApprenant(Apprenant apprenant) throws SQLException {	
		...
		prepareStatement.executeUpdate();
		System.out.println("L'apprenant "+apprenant.getPrenom()+ " " + apprenant.getNom() + " a été ajouté à la base de données");
	}
